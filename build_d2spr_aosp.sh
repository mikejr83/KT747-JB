...
make VARIANT_DEFCONFIG=cyanogen_d2spr_defconfig SELINUX_DEFCONFIG=m2selinux_defconfig KT747_d2_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../KT747-AOSP-KK-SPR*.zip
	zip -r ../KT747-AOSP-KK-SPR-$curdate.zip .
	cd $KERNELDIR
else
